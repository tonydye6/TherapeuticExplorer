    ...
    <>
      <div className={`${inTabView ? "" : "container py-8 md:py-10"} max-w-6xl mx-auto px-4 sm:px-6 lg:px-8`}>
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          {/* Featured PDFs and Resources Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
            <Card className="rounded-sophera-card border-sophera-border-primary bg-sophera-bg-card shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4 md:p-5 flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-sophera-brand-primary/10 flex items-center justify-center flex-shrink-0">
                  <Download className="h-6 w-6 text-sophera-brand-primary" />
                </div>
                <div>
                  <h3 className="font-medium text-sophera-text-heading mb-1">Patient Guide</h3>
                  <p className="text-sm text-sophera-text-body">
                    Comprehensive guide for newly diagnosed patients with essential information.
                  </p>
                  <Button 
                    variant="outline"
                    ...
                    size="sm"
                    onClick={() => handleDownloadPDF("Patient Guide")}
                  >
            ...
            <Card className="rounded-sophera-card border-sophera-border-primary bg-sophera-bg-card shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4 md:p-5 flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-sophera-accent-tertiary/10 flex items-center justify-center flex-shrink-0">
                  <Download className="h-6 w-6 text-sophera-accent-tertiary" />
                </div>
                <div>
                  <h3 className="font-medium text-sophera-text-heading mb-1">Treatment Tracker</h3>
                  <p className="text-sm text-sophera-text-body">
                    Printable worksheet to track treatments, appointments, and medications.
                  </p>
                  <Button 
                    variant="outline"
                    className="mt-3 border-sophera-border-primary text-sophera-brand-primary hover:bg-sophera-brand-primary-light hover:text-sophera-brand-primary-dark rounded-sophera-button"
            ...
            <Card className="rounded-sophera-card border-sophera-border-primary bg-sophera-bg-card shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4 md:p-5 flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-sophera-accent-secondary/10 flex items-center justify-center flex-shrink-0">
                  <Download className="h-6 w-6 text-sophera-accent-secondary" />
                </div>
                <div>
                  <h3 className="font-medium text-sophera-text-heading mb-1">Nutrition Guide</h3>
                  <p className="text-sm text-sophera-text-body">
                    Special dietary recommendations for esophageal cancer patients.
                  </p>
                  <Button 
                    variant="outline"
                    className="mt-3 border-sophera-border-primary text-sophera-brand-primary hover:bg-sophera-brand-primary-light hover:text-sophera-brand-primary-dark rounded-sophera-button"
          ...
          {/* Extra Resources (Ask AI, Suggest Resource) */}
              ...
              <CardContent className="p-4 md:p-5 flex items-center gap-4">
                ...
                <div>
                  ...
                  <Button 
                    ...
                    size="sm"
                    onClick={() => window.location.href = '/research-assistant'}
                  >
      ...
      <Dialog open={isResourceDialogOpen} onOpenChange={setIsResourceDialogOpen}>
        <DialogContent className="rounded-sophera-card border-sophera-border-primary bg-sophera-bg-card max-w-md">
          <DialogHeader>
            <DialogTitle className="text-sophera-text-heading text-xl">Suggest a Resource</DialogTitle>
            <DialogDescription className="text-sophera-text-body pt-1.5">
              Share a helpful resource with the Sophera community. Our team will review your suggestion.
            </DialogDescription>
          </DialogHeader>
          
          <form onSubmit={handleSuggestResource} className="space-y-4 mt-2">
            <div className="space-y-2">
              <Label htmlFor="resourceName" className="text-sophera-text-heading">Resource Name</Label>
              <Input 
                id="resourceName" 
                placeholder="E.g., Esophageal Cancer Support Network" 
            ...
            <div className="space-y-2">
              <Label htmlFor="resourceUrl" className="text-sophera-text-heading">Website URL</Label>
              <Input 
                id="resourceUrl" 
            ...
            <div className="space-y-2">
              <Label htmlFor="resourceDescription" className="text-sophera-text-heading">Description</Label>
              <Textarea 
                id="resourceDescription" 
                placeholder="Please describe how this resource could help cancer patients or caregivers..." 
                className="rounded-sophera-input border-sophera-border-primary focus:border-sophera-brand-primary min-h-[120px]"
                required
              />
            </div>
            
            <div className="space-y-2">
              <Label htmlFor="resourceCategory" className="text-sophera-text-heading">Category</Label>
              <Select defaultValue="support-groups">
                <SelectTrigger id="resourceCategory" className="rounded-sophera-input border-sophera-border-primary focus:border-sophera-brand-primary">
            ...
            <DialogFooter className="pt-4">
              <Button 
                ...
                className="border-sophera-border-primary text-sophera-text-body hover:bg-sophera-gradient-start/20 rounded-sophera-button"
              >
                Cancel
              </Button>
              <Button 
                type="submit" 
                className="bg-sophera-brand-primary hover:bg-sophera-brand-primary-dark text-white rounded-sophera-button ml-2"
              >
                Submit Suggestion
              </Button>
            </DialogFooter>
